...
const routes: Routes = [
  ...
  { path: 'add-aula', loadChildren: './add-aula/add-aula.module#AddAulaPageModule', canActivate: [AuthGuard]},
  { path: 'add-aula/:id', loadChildren: './add-aula/add-aula.module#AddAulaPageModule', canActivate: [AuthGuard] },
